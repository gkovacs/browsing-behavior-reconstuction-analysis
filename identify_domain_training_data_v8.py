#!/usr/bin/env python
# md5: 37929bd187e69a188c65c1b7323af0f2
# coding: utf-8
...
data_version = 4+8+8+8+8+8+8 + num_prev_enabled
...
def get_rows_for_user(user, include_domain=False):
  ...
  for idx,visit in enumerate(ordered_visits):
    ...
    for time_sec in xrange(cur_time_sec+1, next_time_sec):
      ...
      cached_locals = {"time_sec": time_sec, "user": user, "ref_domain": ref_domain, "label": label, "since_cur": since_cur, "to_next": to_next, "n_eq_c": n_eq_c, "nref_eq_c": nref_eq_c, "nref_eq_zero": nref_eq_zero, "since_prev1": since_prev1, "n_eq_p1": n_eq_p1, "nref_eq_p1": nref_eq_p1, "visits_since_p1": visits_since_p1, "since_prev2": since_prev2, "n_eq_p2": n_eq_p2, "nref_eq_p2": nref_eq_p2, "visits_since_p2": visits_since_p2, "since_prev3": since_prev3, "n_eq_p3": n_eq_p3, "nref_eq_p3": nref_eq_p3, "visits_since_p3": visits_since_p3, "since_prev4": since_prev4, "n_eq_p4": n_eq_p4, "nref_eq_p4": nref_eq_p4, "visits_since_p4": visits_since_p4, "since_prev5": since_prev5, "n_eq_p5": n_eq_p5, "nref_eq_p5": nref_eq_p5, "visits_since_p5": visits_since_p5, "since_prev6": since_prev6, "n_eq_p6": n_eq_p6, "nref_eq_p6": nref_eq_p6, "visits_since_p6": visits_since_p6, "since_prev7": since_prev7, "n_eq_p7": n_eq_p7, "nref_eq_p7": nref_eq_p7, "visits_since_p7": visits_since_p7}
