#!/usr/bin/env python
# md5: c957e006f07005bc6a99a94f61345dd2
# coding: utf-8
...
user_data_to_csv('catdata_train_tensecond.csv', training_users, get_activespan_data_tensecond)
user_data_to_csv('catdata_test_tensecond.csv', test_users, get_activespan_data_tensecond)
user_data_to_csv('catdata_train_insession_tensecond.csv', training_users, get_activespan_data_tensecond_insession)
user_data_to_csv('catdata_test_insession_tensecond.csv', test_users, get_activespan_data_tensecond_insession)
user_data_to_csv('catdata_train_second.csv', training_users, get_activespan_data_second)
user_data_to_csv('catdata_test_second.csv', test_users, get_activespan_data_second)
user_data_to_csv('catdata_train_insession_second.csv', training_users, get_activespan_data_second_insession)
user_data_to_csv('catdata_test_insession_second.csv', test_users, get_activespan_data_second_insession)
